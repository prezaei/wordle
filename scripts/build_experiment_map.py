...
N = {
  ...
  "rft_stage2": ("scale", "stage-2 RFT (on-policy distill)", "≈50M", "distill the model's OWN best-of-N winning games back into greedy (RAFT); gentle LR was the unlock", "0.319 · valid 0.681 (+0.038)", "clean"),
  "validity_max": ("scale", "validity-max (composition)", "≈50M", "crank aux λ3 + distill own constrained-decode games to push in-weights spelling", "0.305 · valid 0.712", "clean"),
