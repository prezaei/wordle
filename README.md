...
The **dictionary/spelling aid at inference is the lever** (0.281→0.436); sample-and-vote adds on top
(→**0.632**) but only because it has valid candidates to vote among — compute over raw free-gen samples
*hurts* (0.243). **The honest 0.632 cleanly replaces the old contaminated 0.62.** Honesty win: DPO's
earlier 0.616→0.631 was **contamination-dependent** (null on the clean base). Two numbers to quote:
**0.281 (model alone)** and **0.632 (model + honest aided decoding).**
